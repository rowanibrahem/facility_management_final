...
import 'package:facility_management/features/home/views/la_z_boyScreen.dart';
                          ...
                          child: GestureDetector(
                            onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>
                                  LaZBoyScreen(index: index,heartColor:colorBool[index],),));
                            },
                            child: Container(
                                  ...
                                  Stack(
                                    children: [
                                      Positioned(
                                          ...
                                          child: SizedBox(
                                              ...
                                              child:
                                              Image.asset(AssetData.discoverScreenImages[index],fit: BoxFit.fill,)
                                    ...
                                    const  Positioned(
                                       ...
                                       Positioned(
                                          ...
                                          right: 10,
                                          child: IconButton(
                                            icon: Icon(colorBool[index]? Icons.favorite:Icons.favorite_outline),color: colorBool[index]? Colors.red : Colors.black, onPressed: () {
                                            setState(() {
